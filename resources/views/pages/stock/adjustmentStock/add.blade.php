            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="{{ route('penyesuaian.stok.cart') }}" method="POST">
                            @csrf
                            <div class="col-md-12">
                                    ...
                                    @foreach ($carts as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form action="{{ route('penyesuaian.stok.cart.delete', $item->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
                                        ...
                                        @include('pages.stock.adjustmentStock.cart.update')
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
